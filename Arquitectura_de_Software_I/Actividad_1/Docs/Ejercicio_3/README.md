...
2. [Análisis del Escenario](#análisis-del-escenario)
3. [Justificación del Patrón Mediator](#justificación-del-patrón-mediator)
4. [Implementación de la Solución](#implementación-de-la-solución)
